        ...
        <section className="vertPadding light" id="about">
            <div className="container">
                ...
                <p style={{ marginBottom: '2.2rem' }}>
                    ...
                    creating branded content programs to connect our partners
                    with Hearst’s hyper-engaged audiences or producing custom
                    content programs for our partners to use in their own
                    environments, we always employ a combination of data-driven
                    insight and editorial instinct. Being part of Hearst means
                    our data signals span industries and passion points and our
                    editors are in constant conversation with audiences of all
                    kinds. The result: stories that not only get attention but
